...
import wecui.LiteModWorldEditCUI;
...
public class WorldEditCUIConfigPanel extends Gui implements ConfigPanel
{
	...
	public WorldEditCUIConfigPanel()
	{
	...
	public void onPanelShown(ConfigPanelHost host)
	{
		...
		{
			this.controlList.add(new GuiColourButton(this.mc, nextId, 10, nextId * 24, 40, 20, color));
	...
	public void drawPanel(ConfigPanelHost host, int mouseX, int mouseY, float partialTicks)
	{
		for (GuiControl control : this.controlList)
		{
			control.drawControl(this.mc, mouseX, mouseY);
		}
