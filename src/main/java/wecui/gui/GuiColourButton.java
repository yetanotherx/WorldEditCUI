...
public class GuiColourButton extends GuiControl
{
	...
	private LineColor lineColour;
	
	private GuiColourPicker picker;
	
	private boolean pickerClicked = false;
	
	public GuiColourButton(Minecraft minecraft, int id, int xPosition, int yPosition, int controlWidth, int controlHeight, LineColor lineColour)
	{
	 ...
	 * @param lineColour
	 */
	public void updateColour(LineColor lineColour)
	{
	...
	{
		if (getColour) this.colour = this.picker.getColour();
		this.picker = null;
