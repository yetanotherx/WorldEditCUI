...
public class GuiControl extends GuiButton
{
	...
	public void drawTexturedModalRectRot(int x, int y, int x2, int y2, int u, int v, int u2, int v2)
	{
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(x2, y2, this.zLevel, (float)(u) * texMapScale, (float)(v2) * texMapScale);
		tessellator.addVertexWithUV(x2, y, this.zLevel, (float)(u2) * texMapScale, (float)(v2) * texMapScale);
		tessellator.addVertexWithUV(x, y, this.zLevel, (float)(u2) * texMapScale, (float)(v) * texMapScale);
		tessellator.addVertexWithUV(x, y2, this.zLevel, (float)(u) * texMapScale, (float)(v) * texMapScale);
		tessellator.draw();
	}
	...
	public void drawTexturedModalRectRot(int x, int y, int u, int v, int width, int height)
	{
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(x + height, y + width, this.zLevel, (float)(u) * texMapScale, (float)(v + height) * texMapScale);
		tessellator.addVertexWithUV(x + height, y, this.zLevel, (float)(u + width) * texMapScale, (float)(v + height) * texMapScale);
		tessellator.addVertexWithUV(x, y, this.zLevel, (float)(u + width) * texMapScale, (float)(v) * texMapScale);
		tessellator.addVertexWithUV(x, y + width, this.zLevel, (float)(u) * texMapScale, (float)(v) * texMapScale);
		tessellator.draw();
	}
	...
	public void drawTexturedModalRect(int x, int y, int x2, int y2, int u, int v, int u2, int v2)
	{
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(x, y2, this.zLevel, (float)(u) * texMapScale, (float)(v2) * texMapScale);
		tessellator.addVertexWithUV(x2, y2, this.zLevel, (float)(u2) * texMapScale, (float)(v2) * texMapScale);
		tessellator.addVertexWithUV(x2, y, this.zLevel, (float)(u2) * texMapScale, (float)(v) * texMapScale);
		tessellator.addVertexWithUV(x, y, this.zLevel, (float)(u) * texMapScale, (float)(v) * texMapScale);
		tessellator.draw();
	}
	...
	public void drawTexturedModalRect(int x, int y, int u, int v, int width, int height, float texMapScale)
	{
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV(x + 0, y + height, this.zLevel, (float)(u + 0) * texMapScale, (float)(v + height) * texMapScale);
		tessellator.addVertexWithUV(x + width, y + height, this.zLevel, (float)(u + width) * texMapScale, (float)(v + height) * texMapScale);
		tessellator.addVertexWithUV(x + width, y + 0, this.zLevel, (float)(u + width) * texMapScale, (float)(v + 0) * texMapScale);
		tessellator.addVertexWithUV(x + 0, y + 0, this.zLevel, (float)(u + 0) * texMapScale, (float)(v + 0) * texMapScale);
		tessellator.draw();
	}
