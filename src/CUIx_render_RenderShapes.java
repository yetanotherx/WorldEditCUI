...
/**
 * Actually renders various shapes. Uses obfuscated code from CUIx_obf_Handler.
 * 
 * @author lahwran
 * @author yetanotherx
 *
 */
public class CUIx_render_RenderShapes {
     ...
     */
    public static void box(CUIx_render_LineInfo info, double x1, double y1, double z1, double x2, double y2, double z2) {
        info.prepareRender();
     ...
     * @param z2 Z of second vertex
     */
    public static void gridSurface(CUIx_render_LineInfo info, double x1, double y1, double z1, double x2, double y2, double z2) {
        info.prepareRender();
        CUIx_obf_Handler o = CUIx_obf_Handler.instance;
        o.draw_begin(GL11.GL_LINES);
        info.prepareColor();
